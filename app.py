...
st.set_page_config(page_title="Package Extractor Demo", layout="wide")
st.title("Package Extractor Demo")
st.caption("Extract flavors and some other features directly from the product image")
